...
# Função para realizar depósito que soma o valor depositado ao saldo e atualiza o extrato
...
# Função para realizar saque que verifica limites e atualiza saldo e extrato
...
# Função para exibir o extrato com o saldo atual
